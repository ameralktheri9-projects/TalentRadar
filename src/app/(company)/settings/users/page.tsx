...
const ROLE_LABELS: Record<string, string> = {
  ...
  TA_LEAD: "قائد التوظيف",
  BU_MANAGER: "مدير وحدة الأعمال",
};
...
export default function CompanyUsersPage() {
  ...
  async function handleInvite() {
    ...
    const res = await fetch("/api/auth/invite", {
      ...
      body: JSON.stringify({ email: inviteEmail, role: inviteRole, orgType: "COMPANY" }),
    });
    if (res.ok) {
      setShowModal(false);
      setInviteEmail("");
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                >
                  ...
                  <option value="TA_LEAD">قائد التوظيف</option>
                  <option value="BU_MANAGER">مدير وحدة الأعمال</option>
                </select>
              </div>
            </div>
